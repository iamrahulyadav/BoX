...
/**
 * Created by ritwik on 26-08-2018.
 */
...
public class EditRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = EditRoomActivity.this;
    ...
    public void onSaveClick(View view) {
        ...
        if (appliances.size() < 1) {
            Util.showMessageWithOk(EditRoomActivity.this, "Please add an Appliance.");
            return;
        }
        ...
        Toast.makeText(mContext, "Room Configuration Saved.", Toast.LENGTH_SHORT).show();
    ...
    public void onAddApplianceClick(View view) {
        ...
        if (appliances.size() == 8) {
            Util.showMessageWithOk(EditRoomActivity.this, "You have already added 8 Appliances");
            return;
        } else {
