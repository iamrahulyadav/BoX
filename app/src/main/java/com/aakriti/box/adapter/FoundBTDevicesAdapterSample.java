 ...
 */
public class FoundBTDevicesAdapterSample extends ArrayAdapter<BluetoothObject>
{
    private Context context;
    private ArrayList<BluetoothObject> arrayFoundDevices;

    public FoundBTDevicesAdapterSample(Context context, ArrayList<BluetoothObject> arrayOfAlreadyPairedDevices)
    {
