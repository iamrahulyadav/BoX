...
public class RoomSetAdapter extends BaseAdapter {
    ...
    public RoomSetAdapter(Context mContext, ArrayList<Room> rooms) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            hView = mInflater.inflate(R.layout.listview_item_room_control, null);
            ViewHolder holder = new ViewHolder();
            holder.tv_roomName = (TextView) hView.findViewById(R.id.tv_roomName);
            holder.iv_room = (ImageView) hView.findViewById(R.id.iv_room);
        ...
        holder.iv_room.setImageDrawable(mContext.getResources().getDrawable(rooms.get(position).getImageId()));
